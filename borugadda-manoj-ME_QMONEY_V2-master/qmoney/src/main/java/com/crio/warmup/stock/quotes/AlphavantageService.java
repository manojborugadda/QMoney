...
public class AlphavantageService implements StockQuotesService {
  ...
  public List<Candle> getStockQuote(String symbol, LocalDate from, LocalDate to) throws StockQuoteServiceException
  {
    ...
    //   String uString = buildUri(symbol);
    //   String result = restTemplate.getForObject(uString, String.class);
    //   AlphavantageDailyResponse alphavantageDailyResponse = objectMapper.readValue(result, AlphavantageDailyResponse.class);
    ...
    String responseString = restTemplate.getForObject(buildUri(symbol), String.class);
            ...
            try {
              ...
              ObjectMapper objectMapper = getObjectMapper();
              alphavantageDailyResponse = objectMapper.readValue(responseString, AlphavantageDailyResponse.class);
  ...
  private String buildUri(String symbol) {
    String uriTemplate = "https://www.alphavantage.co/query?function=TIME_SERIES_DAILY_ADJUSTED&symbol="+symbol+"&outputsize=full&apikey="+"M62GE2NQA6KW9ZIH";
    return uriTemplate;
}
